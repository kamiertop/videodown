                      ...
                      <div>
                        <div class="relative">
                          <div
                            ...
                            <div
                                class="h-20 w-20 shrink-0 overflow-hidden rounded-full bg-base-200 ring-4 ring-base-100">
                            ...
                            <div class="min-w-0 flex-1">
                              <div class="flex flex-wrap items-center gap-2">
                                <h3 class="truncate text-xl font-black text-base-content">
                                  {account().user.nickname || "抖音用户"}
                                </h3>
                                <Show when={account()}>
                                  <span class="badge badge-outline">
                                    抖音号 {account().user.unique_id}
                                  </span>
                                  <span class="badge badge-outline truncate">
                                    OwnerSecUid：{profile()?.user.sec_uid}
                                  </span>
                                </Show>
                              </div>
