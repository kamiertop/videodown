        ...
        {(media) => (
          ...
          >
            <div
              ...
              <Show when={media.cover !== ""} fallback={<NoCover/>}>
              ...
              <div
                ...
                <div class="flex items-center gap-2.5 text-white/90">
                  <span class="flex items-center gap-0.5 text-xs">
                    <IconEye class="h-3 w-3"/> {formatCount(media.play)}
                  </span>
                  <span class="flex items-center gap-0.5 text-xs">
                    <IconChat class="h-3 w-3"/>{formatCount(media.danmaku)}
                  </span>
                </div>
              ...
              <div class="mt-1.5 flex items-center justify-between">
                ...
                <div class="flex shrink-0 items-center gap-1.5">
                  <Show when={media.pubtime}>
                    <span class="text-xs tabular-nums text-base-content/45">{formatDate(media.pubtime)}</span>
                  </Show>
