...
/** 下载页顶部的批量任务卡片：布局与交互见共用的 BatchSessionCards，这里只提供抖音的状态文案。 */
export default function DouyinBatchStatusCard(): JSXElement {
  return (
      <BatchSessionCards
          sessions={douyinBatchSessions}
          statusBadge={statusBadge}
          onDismiss={dismissDouyinBatch}
          onResume={resumeDouyinBatch}
          onStop={stopDouyinBatch}
      />
  );
}
