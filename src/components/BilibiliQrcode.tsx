...
export default function BilibiliQrcode(): JSXElement {
    ...
    const [qrExpired, setQrExpired] = createSignal<boolean>(false); // 二维码是否失效
    ...
    return (
        <div class="h-full flex flex-col items-center justify-center">
            ...
            <Show when={qrUrl()}>
                <div
                    class="flex flex-col items-center gap-4 p-6 bg-neutral-100 dark:bg-neutral-800 rounded-lg w-fit min-w-75 relative">
                    {/* 二维码容器 */}
                    <div class="relative">
                        <SolidQR
                            text={qrUrl()!}
